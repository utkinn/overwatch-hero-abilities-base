...
ability1Material = Material(abilityMaterials[1])
ability2Material = Material(abilityMaterials[2])
ultimateMaterial = Material(HEROES[LocalPlayer():GetNWString("hero")].ultimateMaterial)
