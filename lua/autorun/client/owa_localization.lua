phrases =
{
	...
	["ui.settings.admin"] = {"Admin Settings", "Для администраторов"},
	...
	["ui.heroSettings.category"] = {"OWA Settings: Heroes", "Настройки OWA: Герои"},
	...
	["ui.settings.hero.adminOnly"] = {"Admins only", "Только для администраторов"},
	["ui.settings.hero.cooldown"] = {": cooldown", ": время восстановления"},
	["ui.settings.hero.ultimateChargeMultiplier"] = {": charge multiplier", ": множитель заряда"},
